...
<title>Load Data From CSV Files</title>
</head>
<body>
<nav class="navbar navbar-default">
	...
	<h3>Please add entries into excel files located in the files folder of the project</h3>
	<h4>Do take action of adding data only when the data is valid and doesn't contain duplicate entries<br>make sure that the tables have already been created</h4>
	<div class="container">
		<form action="LoadData" method = "POST" align=center>
