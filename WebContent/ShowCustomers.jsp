...
//JDBC driver and database URL Localhost
	...
	Connection con=null,conFetch1=null,conFetch2=null;
	Statement stmt=null;
	ResultSet res = null;
	int IdNo=0;
	Class.forName(JDBC_Driver).newInstance();
	con=DriverManager.getConnection(Db_Url, user, pwd);
	conFetch1=DriverManager.getConnection(Db_Url, user, pwd);
	conFetch2=DriverManager.getConnection(Db_Url, user, pwd);
	String query="select IdNo,name,phone,address,customerType from customer";
